...
notebook = {'cells': [{'cell_type': 'markdown',
           ...
           {'cell_type': 'code',
            ...
            'source': ['# Baca file SWBM static\n',
                       ...
                       'MNm)")']},
           {'cell_type': 'markdown',
            'id': 'load-visualize-swbm-intro',
            'metadata': {},
            'source': ['### 1.0 Visualisasi Still Water Bending Moment (SWBM) Kapal\n',
                       'Berikut adalah grafik distribusi Still Water Bending Moment (SWBM) statis di sepanjang panjang '
                       'kapal (`Position (m)`) yang diperoleh dari file `SWBM.csv`. Momen vertikal, horizontal, dan '
                       'torsional digambarkan secara terpisah untuk memperlihatkan karakteristik distribusinya.']},
           {'cell_type': 'code',
            'execution_count': None,
            'id': 'load-visualize-swbm',
            'metadata': {},
            'outputs': [],
            'source': ['# Visualisasi Still Water Bending Moment (SWBM) sepanjang panjang kapal\n',
                       'fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(14, 5))\n',
                       'fig.patch.set_facecolor(BG)\n',
                       '\n',
                       '# Plot Vertical SWBM\n',
                       'ax1.set_facecolor(BG)\n',
                       "ax1.plot(df_swbm['Position (m)'], df_swbm['Vertical SWBM (N.m)'] / 1e6, color=COLORS['vert'], "
                       "lw=2.0, label='Vertical SWBM')\n",
                       "ax1.set_title('Vertical Still Water Bending Moment (VSWBM)', fontsize=11, fontweight='bold', "
                       'color=TEXT)\n',
                       ...
                       "ax2.plot(df_swbm['Position (m)'], df_swbm['Horiontal SWBM (N.m)'] / 1e3, color=COLORS['lat'], "
                       "lw=1.5, label='Horizontal SWBM')\n",
                       "ax2.plot(df_swbm['Position (m)'], df_swbm['Torsional SWBM (N.m)'] / 1e3, color=COLORS['tors'], "
                       "lw=1.5, label='Torsional SWBM')\n",
                       "ax2.set_title('Horizontal & Torsional Still Water Bending Moment', fontsize=11, "
                       ...
                       '\n',
                       "plt.suptitle('Still Water Bending Moment (SWBM) Distribution along Ship Length', fontsize=13, "
           ...
           {'cell_type': 'code',
            ...
            'source': ['# Visualisasi beban total kombinasi (VBM Total) untuk 6 variasi dalam MNm\n',
                       ...
                       '        \n',
                       '        if D == 180:\n',
                       "            c1, c2, c3 = 'Momen Vertikal (N.m)', 'Momen Horizontal (N.m)', 'Momen Torsional "
                       "(N.m)'\n",
                       '        else:\n',
                       "            c1, c2, c3 = 'Momen Horizontal (N.m)', 'Momen Vertikal (N.m)', 'Momen Torsional "
                       "(N.m)'\n",
                       '        \n',
                       '        f1 = df_wbm[c1]\n',
                       '        f2 = df_wbm[c2]\n',
           ...
           {'cell_type': 'code',
            ...
            'metadata': {},
            'outputs': [],
            'source': ['# Hitung statistik mean & standar deviasi total load untuk ke-6 variasi dengan kombinasi 3 '
                       'komponen\n',
                       'load_stats_list = []\n',
